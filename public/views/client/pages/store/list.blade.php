...
@section('title', 'Mağaza - Yılmaz Peyzaj')
@section('description', 'Mağaza.')
										...
										<ul class="option-box clearfix">
											<li class="add-fav">
												<a href="#">
													...
													<span class="t-tip">Favorilere Ekle</span>
												</a>
											</li>
											<li>
								...
								<div class="clearfix">
									<div class="pull-left">
										<a href="#" class="theme-btn btn-style-three">
											<span class="btn-title">Filtrele</span>
										</a>
									</div>
